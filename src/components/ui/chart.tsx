...
// Define our own payload types since Recharts types have changed
type TooltipPayload = {
  name?: string;
...
// Define the tooltip content props interface
...
/** ---------- TOOLTIP (typed as renderer props) ---------- */
...
>(({ className, hideIcon = false, payload, verticalAlign = "bottom", nameKey }, ref) => {
  ...
  const items: LegendPayload[] = Array.isArray(payload) ? (payload as LegendPayload[]) : [];
