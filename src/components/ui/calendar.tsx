      ...
      components={
        {
          Chevron: (chevProps) => {
            const Icon =
              chevProps.orientation === "left" ? ChevronLeft : ChevronRight;
            // react-day-picker forwards className/aria props; spread them if you like
            return <Icon className={cn("h-4 w-4", chevProps.className)} />;
          },
        } satisfies Partial<DayPickerProps["components"]>
      }
      {...props}
    />
  );
